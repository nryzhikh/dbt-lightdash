SELECT
    ...
    (   
       ...
       COALESCE(CAST(ots_all_25_44_inc_3_5 AS NUMERIC), 0) +
       COALESCE(CAST(ots_all_25_45 AS NUMERIC), 0) +
       ...
       COALESCE(CAST(ots_all_25_60 AS NUMERIC), 0) +
       COALESCE(CAST(ots_all_25_60_c AS NUMERIC), 0) +
       COALESCE(CAST(ots_all_30_60_c AS NUMERIC), 0) +
